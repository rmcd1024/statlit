...
<!--
## Kellogg Research Support is trying to help...

* [Kellogg Dataverse](https://ksmr06.kellogg.northwestern.edu) archive now available 
    * Permits archiving and sharing of datasets
    * You control permissions
    * Can privately share with coauthors
* [Kellogg Gitlab server](https://ksmr05.kellogg.northwestern.edu)  now available
    * Can have private git account with sharing
    * Commercial git server either charge for private accounts or charge for teams over a certain size
-->
...
* You can have references, for example @taibbi:11, @mcdonald/paulson:15, @wickham:14-ar, @wickham:15-rpkg, and @brennan/mcdonald:15-taxnotes
